...
场景八: 分析卡点 → 自动创建任务
  ...
  你: Montessori app 推不动了，分析下
  Agent:
    分析项目文件、git log、现有任务...
    发现 3 个卡点，已创建任务:
      T-017 [P1] 集成 MOSS-TTS 到语音对话模块
      T-018 [P2] 补充 persona_gallery_screen 的路由配置
      T-019 [P2] 整理教育家 system prompt 数据
    建议从 T-017 开始

  关键: 不需要你说"创建任务"，agent 分析完直接建。
